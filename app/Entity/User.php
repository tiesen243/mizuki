...
class User extends Entity
{
  ...
  public function validate(array $fields): array {
    ...
    if (in_array('identifier', $fields, true) || empty($fields)) {
      if (empty($this->username) && empty($this->email)) {
        $errors['identifier'] = 'Username or email is required.';
      }
    }

    if (in_array('username', $fields, true) || empty($fields)) {
    ...
    if (in_array('email', $fields, true) || empty($fields)) {
      if (empty($this->email)) {
    ...
    if (in_array('password', $fields, true) || empty($fields)) {
