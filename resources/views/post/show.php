<main class="container py-4">
  <div class="flex items-center justify-between mb-4">
    ...
    <a href="/posts/<?php echo urlencode($post->id); ?>/edit" class="inline-flex items-center justify-center h-9 px-3 rounded-md bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 transition-colors">
      Edit Post
    </a>
  </div>
